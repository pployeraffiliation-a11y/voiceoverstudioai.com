...
<video aria-label="Kling AI image to video — boy animation" controls playsInline preload="none">
...
<div className="media-card">
<video aria-label="Kling AI image to video — cat animation" controls playsInline preload="none">
...
<div className="media-card">
<video aria-label="Kling AI image to video — dragon animation" controls playsInline preload="none">
...
<div className="media-card">
<video aria-label="Kling AI image to video — halo spiral animation" controls playsInline preload="none">
