...
<video aria-label="Kling AI multi-shot demo — sequence 1" controls playsInline preload="none">
<source src="/assets/videos/kling-multishot-demo-1.mp4" type="video/mp4" />
</video>
</div>
<div className="media-card">
<video aria-label="Kling AI multi-shot demo — sequence 2" controls playsInline preload="none">
<source src="/assets/videos/kling-multishot-demo-2.mp4" type="video/mp4" />
</video>
</div>
<div className="media-card">
<video aria-label="Kling AI multi-shot demo — sequence 3" controls playsInline preload="none">
