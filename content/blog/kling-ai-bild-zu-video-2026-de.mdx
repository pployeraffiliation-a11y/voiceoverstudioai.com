...
<video aria-label="Kling AI Bild zu Video — Jungen-Animation" controls playsInline preload="none">
...
<div className="media-card">
<video aria-label="Kling AI Bild zu Video — Katzen-Animation" controls playsInline preload="none">
...
<div className="media-card">
<video aria-label="Kling AI Bild zu Video — Drachen-Animation" controls playsInline preload="none">
...
<div className="media-card">
<video aria-label="Kling AI Bild zu Video — Halo-Spiralen-Animation" controls playsInline preload="none">
