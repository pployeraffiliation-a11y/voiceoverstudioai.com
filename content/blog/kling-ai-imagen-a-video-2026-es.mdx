...
<video aria-label="Kling AI imagen a vídeo — animación niño" controls playsInline poster="/assets/images/posters/kling-i2v-demo-boy.jpg" preload="none">
...
<div className="media-card">
<video aria-label="Kling AI imagen a vídeo — animación gato" controls playsInline poster="/assets/images/posters/kling-i2v-demo-cat.jpg" preload="none">
...
<div className="media-card">
<video aria-label="Kling AI imagen a vídeo — animación dragón" controls playsInline poster="/assets/images/posters/kling-i2v-demo-dragon.jpg" preload="none">
...
<div className="media-card">
<video aria-label="Kling AI imagen a vídeo — animación espiral halo" controls playsInline poster="/assets/images/posters/kling-i2v-demo-halo.jpg" preload="none">
